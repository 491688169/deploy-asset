...
exports.default = {
  ...
  error: function error(err) {
    ...
    var stack = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  match: function match(list, patterns) {
    var mapFn = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  applyWhiteAndBlackList: function applyWhiteAndBlackList(list, whitePatterns, blackPatterns) {
    var mapFn = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  ...
  getFileType: function getFileType(filename) {
    ...
    var defaultType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _FileType2.default.STATIC.value;
